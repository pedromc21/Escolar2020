namespace Escolar2020.Common.Services
{
    using Models;
    ...
    public class ApiService
    {
        ...
        public async Task<Response> GetListAsync<T>(string urlBase, string servicePrefix, string controller, string parameters, string tokenType, string accessToken)
        {
            try
            {
                var temp = parameters;
                ...
                var Query = temp; //"?clave_Familia=ABARCLAZC";
                var url = $"{servicePrefix}{controller}{Query}";
                var response = await client.GetAsync(url);
                var result = await response.Content.ReadAsStringAsync();
        ...
        public async Task<Response> PutAsync<T>(string urlBase, string servicePrefix, string controller, int id, T model, string tokenType, string accessToken)
        {
            try
            {
                var request = JsonConvert.SerializeObject(model);
