        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Puesto_Empresa = table.Column<int>(maxLength: 250, nullable: false),
                    ...
                    Email_Institucional = table.Column<string>(maxLength: 250, nullable: true),
                    Usuario_Institucional = table.Column<string>(maxLength: 150, nullable: true),
                    Clave_Institucional = table.Column<string>(maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_App_Tutors_AspNetUsers_UserId",
                        column: x => x.UserId,
